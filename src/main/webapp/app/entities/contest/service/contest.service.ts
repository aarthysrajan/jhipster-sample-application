...
export class ContestService {
  ...
  protected convertDateFromClient(contest: IContest): IContest {
    return Object.assign({}, contest, {
      startDate: contest.startDate?.isValid() ? contest.startDate.format(DATE_FORMAT) : undefined,
      endDate: contest.endDate?.isValid() ? contest.endDate.format(DATE_FORMAT) : undefined,
    });
  }
