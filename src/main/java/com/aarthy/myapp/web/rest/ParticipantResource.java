...
/**
 * REST controller for managing {@link com.aarthy.myapp.domain.Participant}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Participant> partialUpdateParticipant(
        ...
        Optional<Participant> result = participantRepository
            ...
            .map(existingParticipant -> {
                if (participant.getfName() != null) {
                    existingParticipant.setfName(participant.getfName());
                }
                if (participant.getmName() != null) {
                    existingParticipant.setmName(participant.getmName());
                }
                if (participant.getlName() != null) {
                    existingParticipant.setlName(participant.getlName());
                }
                if (participant.getUserName() != null) {
                    existingParticipant.setUserName(participant.getUserName());
                }
                if (participant.getUserId() != null) {
                    existingParticipant.setUserId(participant.getUserId());
                }
                if (participant.getDob() != null) {
                    existingParticipant.setDob(participant.getDob());
                }
                if (participant.getEmailId() != null) {
                    existingParticipant.setEmailId(participant.getEmailId());
                }
                if (participant.getPhoneNo() != null) {
                    existingParticipant.setPhoneNo(participant.getPhoneNo());
                }
                if (participant.getNoOfPhotos() != null) {
                    existingParticipant.setNoOfPhotos(participant.getNoOfPhotos());
                }
                if (participant.getProfilePic() != null) {
                    existingParticipant.setProfilePic(participant.getProfilePic());
                }
                if (participant.getUserRating() != null) {
                    existingParticipant.setUserRating(participant.getUserRating());
                }
                if (participant.getNoOfContestsParticipated() != null) {
                    existingParticipant.setNoOfContestsParticipated(participant.getNoOfContestsParticipated());
                }
                if (participant.getNoOfContestsWon() != null) {
                    existingParticipant.setNoOfContestsWon(participant.getNoOfContestsWon());
                }
